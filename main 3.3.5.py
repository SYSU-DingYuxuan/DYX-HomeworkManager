...
def helper():
    ...
    but7 = Button(help_win, text = '关于', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0, command = lambda : reLoadLabel(f'班级作业助手 {VERSON}', '开发者：杭州第二中学钱江学校 202214（现512班） 丁誉轩\n\nQQ: 431495254\n\nBilibili: 卢丁喆丰群\n所有更新消息将在这个账号第一时间发布，敬请关注，欢迎投币）\n\nCSDN: do_while_false\n\n软件官方QQ群：704376858\n你可以在这个群内下载最新版本的软件、反馈问题，也可以与作者交流\n\n源代码不公开。'))
    but8 = Button(help_win, text = '其他功能', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0, command = lambda : reLoadLabel('其他功能', '主界面的时间就是学校时间，误差不超过0.003秒，供参考'))
...
Label(root, bg = '#1e1e1e', fg = 'grey', text = f'班级作业助手 {VERSON} by 丁誉轩 ©  版权所有，侵权必究', font = ('微软雅黑', 6)).place(x = 1920, y = 1080, anchor = SE, width = 250, height = 15)
