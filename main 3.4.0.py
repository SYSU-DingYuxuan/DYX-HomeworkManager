...
def open_osk():
    ...
    OSK_OPENED = 1
    '''
    osk_th = threading.Thread(target = lambda : os.system('osk'), name = 'thread_osk')
    osk_th.setDaemon(True)
    osk_th.start()
...
def BackEdit():
    ...
    osk = Button(edit_win, text = '小 键 盘', font = ('微软雅黑', 17), relief = GROOVE, command = xjp, borderwidth = 0, fg = 'white', bg = '#252526', activebackground = '#3C3C3C', activeforeground = 'white')
...
def helper():
    ...
    Label(help_win, text = f'班级作业助手 {VERSON} 使用说明书', bg = '#1e1e1e', fg = 'white', anchor = W, font = ('微软雅黑', 50)).place(x = 80, y = 20, width = 1760, height = 100)
    ...
    but7 = Button(help_win, text = '关于', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0, command = lambda : reLoadLabel(f'班级作业助手 {VERSON}', f'开发者：杭州第二中学钱江学校 {tgt} 丁誉轩\n\nQQ: 431495254\n\nBilibili: 卢丁喆丰群\n所有更新消息将在这个账号第一时间发布，敬请关注，欢迎投币）\n\nCSDN: do_while_false\n\n软件官方QQ群：704376858\n你可以在这个群内下载最新版本的软件、反馈问题，也可以与作者交流\n\n源代码不公开。'))
...
def shownews():
    ...
    Label(newswid, text = f'班级作业助手 {VERSON} 版本更新', bg = '#333333', fg = 'white', font = ('微软雅黑', 40)).place(x = 0, y = 10, width = 900, height = 100)
    Label(newswid, text = this_new, bg = '#2d2d2d', fg = '#DCDCAA', font = ('consolas', 15), justify = 'left').place(x = 20, y = 120, width = 860, height = 280)
