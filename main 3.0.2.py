...
class WorkFrame:
    ...
    def edit_item(self):
        ...
        chose_win = Tk()
        chose_win.overrideredirect(1)
        chose_win.configure(bg = 'lime')
        chose_win.title('编辑作业项')
        chose_win.geometry('440x540+740+270')
        chose_win.resizable(False, False)
        chose_win.wm_attributes('-topmost', 1)
        ...
        Label(ffff, text = '编 辑 作 业 项', font = ('微软雅黑', 20, 'bold'), bg = '#333333', fg = 'white').place(x = 20, y = 20, width = 400, height = 80)

        Label(ffff, text = '科  目：', font = ('微软雅黑', 16, 'bold'), bg = '#333333', fg = 'white').place(x = 40, y = 100, width = 80, height = 60)
        Label(ffff, text = SubTabID[self.sub_id], font = ('微软雅黑', 16), bg = '#333333', fg = 'white', anchor = 'w').place(x = 100, y = 80, width = 80, height = 60)

        Label(ffff, text = '项  目：', font = ('微软雅黑', 16, 'bold'), bg = '#333333', fg = 'white').place(x = 40, y = 160, width = 80, height = 60)
        xim = tkinter.ttk.Combobox(ffff, background = '#37373D', value = xiang_mu_list.split(), font = ('微软雅黑', 15))
        xim.set(self.name)
        xim.place(x = 120, y = 175, width = 250, height = 30)

        Label(ffff, text = '范  围：', font = ('微软雅黑', 16, 'bold'), bg = '#333333', fg = 'white').place(x = 40, y = 220, width = 80, height = 60)
        pag = tkinter.ttk.Combobox(ffff, background = '#37373D', value = pages_list.split(), font = ('微软雅黑', 15))
        pag.set(self.page)
        pag.place(x = 120, y = 235, width = 250, height = 30)

        Label(ffff, text = '检  查：', font = ('微软雅黑', 16, 'bold'), bg = '#333333', fg = 'white').place(x = 40, y = 280, width = 80, height = 60)
        git = tkinter.ttk.Combobox(ffff, background = '#37373D', value = give_in_time.split(), font = ('微软雅黑', 15))
        git.set(self.time)
        git.place(x = 120, y = 295, width = 250, height = 30)
        ...
        ffff.place(x = 20, y = 20, width = 400, height = 500)
...
def ToolBox():
    ...
    shuo_ming_but = Button(Tool_win, text = '使用说明书', borderwidth = 0,font = ('微软雅黑', 20), relief = GROOVE, fg = 'white', bg = '#252526', activebackground = '#3C3C3C', activeforeground = 'white', command = ING)
