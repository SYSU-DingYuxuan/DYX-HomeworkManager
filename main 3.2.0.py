...
class WorkFrame:
    ...
    def config(self):
        ...
        self.delete_image = PhotoImage(file = PATH + '\\icons\\delete.gif')
        self.edit_image = PhotoImage(file = PATH + '\\icons\\edit.gif')
        ...
        self.b_del = Button(WorkFrameList[-1], image = self.delete_image, bg = '#4E1A0F', fg = '#C54026', activebackground = self._get_color(), relief = 'groove', font = ('微软雅黑', 13), borderwidth = 0, command = self.del_item).pack(side = RIGHT)
        self.b_edit = Button(WorkFrameList[-1], image = self.edit_image, bg = '#212E3A', fg = '#597C9D', activebackground = self._get_color(), relief = 'groove', font = ('微软雅黑', 13), borderwidth = 0, command = self.edit_item).pack(side = RIGHT)
...
def helper():
    ...
    but5 = Button(help_win, text = '设置', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel('设置', '在主界面>>设置图标 中可以修改一些设置。通过点击按钮来修改设置。修改的设置会自动立刻保存，但部分设置要在软件下一次启动时生效。\n\n自动保存：\n自动记录添加的作业，以免意外或非法退出造成的数据丢失。\n\n自动关机：\n开启后，电脑将在21:44:40时启动关机30秒倒计时，30秒后自动关机。\n\n设置功能仍在完善中'))
    ...
    but7 = Button(help_win, text = '其他功能', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel('其他功能', '主界面的时间就是学校时间，误差不超过0.003秒，供参考'))
    ...
    Button(help_win, text = '去 Bilibili 看看视频说明', font = ('微软雅黑', 17), relief = GROOVE, command = surf, borderwidth = 0, fg = 'white', bg = '#252526', activebackground = '#3C3C3C', activeforeground = 'white').place(x = 20, y = 1000, height = 60, width = 400)
...
settings_but = Button(root, image = settings_image, text = '设置', font = ('微软雅黑', 17), relief = GROOVE, command = SetEdit, fg = 'white', bg = '#252526', borderwidth = 0, activebackground = '#3C3C3C', activeforeground = 'white')
settings_but.place(x = 1360, y = 1000, width = 60, height = 60)


help_image = PhotoImage(file = PATH + '\\icons\\help.gif')
shuo_ming_but = Button(root, image = help_image, font = ('微软雅黑', 17), relief = FLAT, command = helper, fg = 'white', bg = '#252526', borderwidth = 0, activebackground = '#3C3C3C', activeforeground = 'white')
shuo_ming_but.place(x = 1440, y = 1000, width = 60, height = 60)

power_shell_but = Button(root, text = '后台管理', font = ('微软雅黑', 17), relief = FLAT, command = BackEdit, borderwidth = 0, fg = 'white', bg = '#252526', activebackground = '#3C3C3C', activeforeground = 'white')
...
Label(root, bg = '#1e1e1e', fg = 'grey', text = f'班级作业助手 {VERSON} by Ding Yuxuan ©  版权所有，侵权必究', font = ('微软雅黑', 6)).place(x = 1920, y = 1080, anchor = SE, width = 270, height = 15)
