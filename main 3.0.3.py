...
def helper():
    ...
    title_label = Label(help_win, bg = '#1f1f1f', fg = 'white', anchor = W, justify = 'left',font = ('微软雅黑', 35))
    title_label.place(x = 320, y = 140, width = 1480, height = 100)

    inner_label = Label(help_win, bg = '#181818', fg = 'white', anchor = W, justify = 'left', font = ('微软雅黑', 19), wraplength = 1480)
    inner_label.place(x = 320, y = 240, height = 700, width = 1480)

    def reLoadLabel(tit, mes):
        title_label.config(text = tit)
        inner_label.config(text = mes)
    ...
    but4 = Button(help_win, text = '后台管理', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel('后台管理', '主界面>>工具箱>>后台管理 可以编辑每一门学科的作业列表，以及预设的范围列表和上交时间列表。'))
    but5 = Button(help_win, text = '关于', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel(f'班级作业助手 {VERSON}', '开发者：杭州第二中学钱江学校 202214 丁誉轩。\n\nQQ: 431495254\n\nBilibili: 卢丁喆丰群  所有更新消息将在这个账号第一时间发布，敬请关注\n\nCSDN: do_while_false\n\n软件官方QQ群：704376858  你可以在这个群内下载最新版本的软件、反馈问题，也可以与作者交流。\n源代码共计1723行，不公开,但是你可以贿赂贿赂我。'))
    but6 = Button(help_win, text = '未来版本前瞻', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel('未来版本前瞻', '未来的版本中，将要实现：\n\n设置功能\n可拖动的作业容器\n每个学科单独的范围、上交时间列表\n\n等等。将花整个高中的时间维护此软件。'))
    but7 = Button(help_win, text = '更新日志', fg = 'white', bg = '#212E3A', font = ('微软雅黑', 20), activebackground = '#3F9CD6', activeforeground = 'white', relief = GROOVE, borderwidth = 0,command = lambda : reLoadLabel('更新日志', \
    '''3.0.0 -> 3.0.1
    新增ReportLAB class
    修复“为空”
...
3.0.2 -> 3.0.3
    ...
    but1.place(x = 120, y = 140 + 100, height = 60, width = 200)
    but2.place(x = 120, y = 200 + 100, height = 60, width = 200)
    but3.place(x = 120, y = 260 + 100, height = 60, width = 200)
    but4.place(x = 120, y = 320 + 100, height = 60, width = 200)
    but5.place(x = 120, y = 380 + 100, height = 60, width = 200)
    but6.place(x = 120, y = 440 + 100, height = 60, width = 200)
    but7.place(x = 120, y = 500 + 100, height = 60, width = 200)
...
Label(root, text = 'Powered by', bg = '#1E1E1E', fg = '#0089E6', font = ('Consolas', 28)).place(x = 860, y = 980, width = 200, height = 40)
