...
def shownews():
    ...
    Label(newswid, text = this_new, bg = '#2d2d2d', fg = '#DCDCAA', font = ('consolas', 15), justify = 'left', wraplength = 860, anchor = 'nw').place(x = 20, y = 120, width = 860, height = 280)
